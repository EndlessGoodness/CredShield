Public Class LoanOffersDatabase
    ...
    Public Shared Function GetAllLoanOffers() As List(Of LoanOffer)
        ...
        Dim hdfc As New LoanOffer("HDFC Bank", "HDFC001", "Home Loan", 500000, 5000000, 6.5, 8.5, 5, 20, 0.5, "3-5 Days",
        ...
        Dim icici As New LoanOffer("ICICI Bank", "ICICI001", "Home Loan", 300000, 7500000, 6.75, 8.75, 5, 20, 0.5, "2-4 Days",
        ...
        Dim sbi As New LoanOffer("State Bank of India", "SBI001", "Home Loan", 250000, 10000000, 6.4, 8.4, 5, 20, 0.4, "4-6 Days",
        ...
        Dim hdfcPersonal As New LoanOffer("HDFC Bank", "HDFC002", "Bank Loan", 50000, 3000000, 9.0, 15.0, 1, 5, 2.0, "Same Day",
        ...
        Dim bajaj As New LoanOffer("Bajaj Finserv", "BAJAJ001", "Bank Loan", 25000, 2500000, 11.0, 16.0, 1, 5, 1.5, "1-2 Hours",
        ...
        Dim indusind As New LoanOffer("IndusInd Bank", "INDUSIND001", "Bank Loan", 50000, 5000000, 8.5, 14.0, 1, 5, 1.0, "1-3 Hours",
        ...
        Dim axis As New LoanOffer("Axis Bank", "AXIS001", "Financial Loan", 100000, 5000000, 10.0, 16.0, 1, 7, 2.5, "3-5 Days",
        ...
        Dim iciciBusiness As New LoanOffer("ICICI Bank", "ICICI002", "Financial Loan", 150000, 7500000, 9.5, 15.5, 1, 7, 2.0, "2-4 Days",
        ...
        Dim kotak As New LoanOffer("Kotak Mahindra Bank", "KOTAK001", "Financial Loan", 100000, 10000000, 9.0, 15.0, 1, 10, 1.5, "1-3 Days",
